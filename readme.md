...
* [Front-end Debugging Tools Handbook](https://github.com/lala-hakobyan/front-end-debugging-handbook) ⭐ 43 | 🐛 0 | 📅 2026-03-12 - Practical guide to mastering front-end debugging tools, from Chrome DevTools and framework extensions to AI-enhanced IDE debugging.
...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 810 | 🐛 724 | 🌐 TypeScript | 📅 2026-02-14 - Elements panel inside VS Code.
...
* [ChromeDevTools/devtools-protocol](https://github.com/chromedevtools/devtools-protocol) ⭐ 1,459 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-03 - **Canonical location of the protocol JSON**. Issue tracker for protocol bugs. TypeScript types.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 94,017 | 🐛 303 | 🌐 TypeScript | 📅 2026-04-03 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,550 | 🐛 23 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,572 | 🐛 607 | 🌐 TypeScript | 📅 2026-04-03 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,416 | 🐛 7 | 📅 2026-03-22.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 12,916 | 🐛 172 | 🌐 Go | 📅 2026-03-23 - High-level actions and tasks for driving browsers
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 6,837 | 🐛 201 | 🌐 Go | 📅 2026-02-17
...
* C#/.NET: [Puppeteer Sharp](https://github.com/hardkoded/puppeteer-sharp) ⭐ 3,868 | 🐛 10 | 🌐 C# | 📅 2026-04-01 - Puppeteer port
* TypeScript/Node.js: [Taiko](https://github.com/getgauge/taiko/) ⭐ 3,664 | 🐛 52 | 🌐 JavaScript | 📅 2026-03-28
* Ruby: [Ferrum](https://github.com/route/ferrum) ⭐ 1,992 | 🐛 33 | 🌐 Ruby | 📅 2026-03-24 - high-level API to control Chrome in Ruby
* Ruby: [Cuprite](https://github.com/machinio/cuprite) ⭐ 1,363 | 🐛 41 | 🌐 Ruby | 📅 2026-04-03 - Capybara driver
...
* Python: [PyCDP](https://github.com/hyperiongray/python-chrome-devtools-protocol) ⭐ 139 | 🐛 84 | 🌐 Python | 📅 2026-04-01 - Pure-Python, sans-IO wrappers. See also the [Trio CDP driver](https://github.com/hyperiongray/trio-chrome-devtools-protocol) ⭐ 71 | 🐛 69 | 🌐 Python | 📅 2026-03-27
* TypeScript/Node.js: [chrome-debugging-client](https://github.com/TracerBench/chrome-debugging-client) ⭐ 135 | 🐛 22 | 🌐 TypeScript | 📅 2026-04-02
...
* Kotlin: [chrome-devtools-kotlin](https://github.com/joffrey-bion/chrome-devtools-kotlin) ⭐ 58 | 🐛 13 | 🌐 Kotlin | 📅 2026-04-03 - A coroutine-based client library, providing low-level CDP primitives and high-level extensions.
* TypeScript/Node.js: [Lumen](https://github.com/omxyz/lumen) ⭐ 40 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-30 - Vision-first browser agent with self-healing deterministic replay over CDP.
...
* C#/.NET: [dotnet-chrome-protocol](https://github.com/seclerp/dotnet-chrome-protocol) ⭐ 28 | 🐛 16 | 🌐 C# | 📅 2026-03-31 - A runtime library and schema code generation tools for Chrome DevTools Protocol support in C#/.NET.
...
* [PonyDebugger](https://github.com/square/PonyDebugger) ⭐ 5,854 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18 - Remote network and data debugging iOS apps with Chrome DevTools.
...
* [ruby/debug](https://github.com/ruby/debug) ⭐ 1,260 | 🐛 91 | 🌐 Ruby | 📅 2026-03-30 - Debugging functionality for Ruby.
...
* [BrowserBox](https://github.com/BrowserBox/BrowserBox) ⭐ 3,812 | 🐛 5 | 🌐 Shell | 📅 2026-04-02 - Embed Chrome in a web page, largely powered by DevTools and supporting multiuser browsing, remote DevTools, audio, and documents like `.docx`, `.pdf`, and more.
...
* [dn](https://github.com/dosyago/dn) ⭐ 3,898 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-28 - Archive and index pages you browse for offline viewing and search, implemented using the `Fetch` domain's interceptions, and works with any Chromium-based browser.
