...
* [Chrome Secret Menus](https://github.com/sparkyrider/chrome-secret-menus) ⭐ 66 | 🐛 1 | 📅 2026-01-21 - Comprehensive guide to internal pages and diagnostic tools in Chrome.
...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 816 | 🐛 883 | 🌐 TypeScript | 📅 2026-02-14 - Elements panel inside VS Code.
...
* [ChromeDevTools/devtools-protocol](https://github.com/chromedevtools/devtools-protocol) ⭐ 1,484 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-13 - **Canonical location of the protocol JSON**. Issue tracker for protocol bugs. TypeScript types.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 94,323 | 🐛 256 | 🌐 TypeScript | 📅 2026-05-13 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,555 | 🐛 24 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 88,728 | 🐛 166 | 🌐 TypeScript | 📅 2026-05-15 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,459 | 🐛 11 | 📅 2026-04-27.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 13,042 | 🐛 175 | 🌐 Go | 📅 2026-03-23 - High-level actions and tasks for driving browsers
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 6,922 | 🐛 206 | 🌐 Go | 📅 2026-02-17
...
* C#/.NET: [Puppeteer Sharp](https://github.com/hardkoded/puppeteer-sharp) ⭐ 3,887 | 🐛 12 | 🌐 C# | 📅 2026-05-14 - Puppeteer port
...
* TypeScript/Node.js: [Lumen](https://github.com/omxyz/lumen) ⭐ 47 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-30 - Vision-first browser agent with self-healing deterministic replay over CDP.
...
* [ruby/debug](https://github.com/ruby/debug) ⭐ 1,265 | 🐛 92 | 🌐 Ruby | 📅 2026-05-13 - Debugging functionality for Ruby.
