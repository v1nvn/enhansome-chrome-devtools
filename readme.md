...
* [Chrome Secret Menus](https://github.com/sparkyrider/chrome-secret-menus) ⭐ 54 | 🐛 2 | 📅 2026-01-21 - Comprehensive guide to internal pages and diagnostic tools in Chrome.
...
* [immutable-devtools](https://github.com/andrewdavey/immutable-devtools) ⭐ 673 | 🐛 11 | 🌐 JavaScript | 📅 2019-11-11 - Custom formatter for Immutable-js values.

### Network Inspection

* [betwixt](https://github.com/kdzwinel/betwixt) ⭐ 4,563 | 🐛 22 | 🌐 JavaScript | 📅 2021-11-23 - System level network proxy, providing inspection via Network panel.
...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 802 | 🐛 529 | 🌐 TypeScript | 📅 2026-02-07 - Elements panel inside VS Code.
* [ChromeREPL](https://github.com/acarabott/ChromeREPL) ⭐ 355 | 🐛 3 | 🌐 Python | 📅 2018-06-12 - Within Sublime Text, use the Chrome console.
...
* [ChromeDevTools/devtools-protocol](https://github.com/chromedevtools/devtools-protocol) ⭐ 1,409 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-08 - **Canonical location of the protocol JSON**. Issue tracker for protocol bugs. TypeScript types.
...
* [chrome-remote-interface Wiki](https://github.com/cyrus-and/chrome-remote-interface/wiki) ⭐ 4,489 | 🐛 13 | 🌐 JavaScript | 📅 2025-02-18 - Many useful recipes.
* [Chrome Protocol Proxy](https://github.com/wendigo/chrome-protocol-proxy) ⭐ 246 | 🐛 1 | 🌐 Go | 📅 2025-01-31 - Tool for debugging clients using devtools protocol.

### The big two automation libraries

* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 93,520 | 🐛 288 | 🌐 TypeScript | 📅 2026-02-08 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,540 | 🐛 19 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,292 | 🐛 596 | 🌐 TypeScript | 📅 2026-02-07 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,361 | 🐛 11 | 📅 2026-01-05.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 12,712 | 🐛 168 | 🌐 Go | 📅 2025-10-07 - High-level actions and tasks for driving browsers
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 6,621 | 🐛 202 | 🌐 Go | 📅 2025-09-29
* JavaScript/Node.js: [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,489 | 🐛 13 | 🌐 JavaScript | 📅 2025-02-18
* Python: [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,937 | 🐛 213 | 🌐 Python | 📅 2024-06-29 - Puppeteer port
* C#/.NET: [Puppeteer Sharp](https://github.com/hardkoded/puppeteer-sharp) ⭐ 3,844 | 🐛 201 | 🌐 C# | 📅 2026-02-06 - Puppeteer port
* TypeScript/Node.js: [Taiko](https://github.com/getgauge/taiko/) ⭐ 3,661 | 🐛 62 | 🌐 JavaScript | 📅 2026-01-28
* Ruby: [Ferrum](https://github.com/route/ferrum) ⭐ 1,969 | 🐛 42 | 🌐 Ruby | 📅 2025-12-25 - high-level API to control Chrome in Ruby
* Ruby: [Cuprite](https://github.com/machinio/cuprite) ⭐ 1,353 | 🐛 50 | 🌐 Ruby | 📅 2025-05-11 - Capybara driver
* PHP: [PuPHPeteer](https://github.com/rialto-php/puphpeteer) ⚠️ Archived - PHP bridge to node Puppeteer
* Java: [jvppeteer](https://github.com/fanyong920/jvppeteer) ⭐ 803 | 🐛 8 | 🌐 Java | 📅 2026-02-03  - Headless Chrome For Java
* Go: [cdp](https://github.com/mafredri/cdp) ⭐ 780 | 🐛 15 | 🌐 Go | 📅 2025-12-07
* Go: [godet](https://github.com/raff/godet) ⭐ 401 | 🐛 2 | 🌐 Go | 📅 2024-08-10
...
* Go: [gcd](https://github.com/wirepair/gcd) ⭐ 186 | 🐛 2 | 🌐 Go | 📅 2024-10-16
* PHP: [chrome-devtools-protocol](https://github.com/jakubkulhan/chrome-devtools-protocol) ⭐ 183 | 🐛 20 | 🌐 PHP | 📅 2026-02-08 - A PHP client library for the protocol.
* TypeScript/Node.js: [chrome-debugging-client](https://github.com/TracerBench/chrome-debugging-client) ⭐ 134 | 🐛 16 | 🌐 TypeScript | 📅 2026-01-21
* Python: [PyCDP](https://github.com/hyperiongray/python-chrome-devtools-protocol) ⭐ 133 | 🐛 64 | 🌐 Python | 📅 2026-01-22 - Pure-Python, sans-IO wrappers. See also the [Trio CDP driver](https://github.com/hyperiongray/trio-chrome-devtools-protocol) ⭐ 71 | 🐛 45 | 🌐 Python | 📅 2026-01-22
...
* Kotlin: [chrome-devtools-kotlin](https://github.com/joffrey-bion/chrome-devtools-kotlin) ⭐ 56 | 🐛 11 | 🌐 Kotlin | 📅 2026-02-07 - A coroutine-based client library, providing low-level CDP primitives and high-level extensions.
...
* C#/.NET: [dotnet-chrome-protocol](https://github.com/seclerp/dotnet-chrome-protocol) ⭐ 27 | 🐛 16 | 🌐 C# | 📅 2026-01-24 - A runtime library and schema code generation tools for Chrome DevTools Protocol support in C#/.NET.
...
* [devtools-remote-debugger](https://github.com/Nice-PLQ/devtools-remote-debugger) ⭐ 407 | 🐛 13 | 🌐 JavaScript | 📅 2025-12-05 - Use devtools against a webpage; a CDP agent implemeted in client-side JS.
...
* [Facebook Stetho](https://github.com/facebook/stetho) ⭐ 12,715 | 🐛 84 | 🌐 Java | 📅 2024-10-26 - Native Android debugging with Chrome DevTools.
* [j2v8-debugger](https://github.com/AlexTrotsenko/j2v8-debugger) ⭐ 93 | 🐛 5 | 🌐 Kotlin | 📅 2025-02-04 - Debugging JavaScript running in [J2V8](https://github.com/eclipsesource/J2V8) ⭐ 2,621 | 🐛 178 | 🌐 Java | 📅 2025-11-14 with Chrome DevTools.
...
* [PonyDebugger](https://github.com/square/PonyDebugger) ⭐ 5,859 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18 - Remote network and data debugging iOS apps with Chrome DevTools.
...
* [ruby/debug](https://github.com/ruby/debug) ⭐ 1,257 | 🐛 90 | 🌐 Ruby | 📅 2025-12-19 - Debugging functionality for Ruby.
...
* [BrowserBox](https://github.com/BrowserBox/BrowserBox) ⭐ 3,779 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-05 - Embed Chrome in a web page, largely powered by DevTools and supporting multiuser browsing, remote DevTools, audio, and documents like `.docx`, `.pdf`, and more.
* [Puppetromium](https://github.com/dosyago/puppetromium) ⭐ 59 | 🐛 1 | 🌐 JavaScript | 📅 2023-07-23 - A proof-of-concept web browser built with Puppeteer, written in Node.js, HTML and CSS, with 0% client-side JavaScript.

### Web Archivers and Indexers

* [dn](https://github.com/dosyago/dn) ⭐ 3,860 | 🐛 21 | 🌐 JavaScript | 📅 2026-02-04 - Archive and index pages you browse for offline viewing and search, implemented using the `Fetch` domain's interceptions, and works with any Chromium-based browser.
...
* [Vue.js Developer Tools](https://github.com/vuejs/vue-devtools) ⭐ 24,791 | 🐛 516 | 🌐 TypeScript | 📅 2024-09-11 - Inspect Vue.js components and manipulate their data.
* [Insight](https://github.com/3Dparallax/insight/) ⭐ 919 | 🐛 22 | 🌐 JavaScript | 📅 2021-09-30 - A WebGL debugging toolkit which enables more productive WebGL development and more efficient WebGL applications.
...
* [TracerBench](https://github.com/TracerBench/tracerbench) ⭐ 249 | 🐛 23 | 🌐 TypeScript | 📅 2023-04-26 - A controlled performance benchmarking tool for web applications, providing clear, actionable and usable insights into performance deltas.
...
* [Puppeteer IDE](https://github.com/gajananpp/puppeteer-ide-extension) ⭐ 241 | 🐛 11 | 🌐 TypeScript | 📅 2023-11-13 - Standalone Puppeteer playground in browser's developer tools.

## Alumni

Old projects, likely not maintained any longer… But still cool.

* [ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,138 | 🐛 14 | 🌐 C | 📅 2025-07-02 - Exposes Mobile Safari & UIWebView instances via the CDP.
...
* [DevTools Backend](https://github.com/christian-bromann/devtools-backend) ⭐ 147 | 🐛 7 | 🌐 JavaScript | 📅 2022-02-01 - Standalone implementation of the Chrome DevTools backend to debug arbitrary web environments.
