...
* [Front-end Debugging Tools Handbook](https://github.com/lala-hakobyan/front-end-debugging-handbook) ⭐ 47 | 🐛 2 | 📅 2026-03-12 - Practical guide to mastering front-end debugging tools, from Chrome DevTools and framework extensions to AI-enhanced IDE debugging.
...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 816 | 🐛 854 | 🌐 TypeScript | 📅 2026-02-14 - Elements panel inside VS Code.
...
* [ChromeDevTools/devtools-protocol](https://github.com/chromedevtools/devtools-protocol) ⭐ 1,483 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-08 - **Canonical location of the protocol JSON**. Issue tracker for protocol bugs. TypeScript types.
...
* [chrome-remote-interface Wiki](https://github.com/cyrus-and/chrome-remote-interface/wiki) ⭐ 4,525 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 - Many useful recipes.
* [Chrome Protocol Proxy](https://github.com/wendigo/chrome-protocol-proxy) ⭐ 250 | 🐛 1 | 🌐 Go | 📅 2025-01-31 - Tool for debugging clients using devtools protocol.

### The big two automation libraries

* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 94,274 | 🐛 299 | 🌐 TypeScript | 📅 2026-05-08 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,554 | 🐛 24 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 88,289 | 🐛 279 | 🌐 TypeScript | 📅 2026-05-09 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,451 | 🐛 8 | 📅 2026-04-27.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 13,020 | 🐛 174 | 🌐 Go | 📅 2026-03-23 - High-level actions and tasks for driving browsers
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 6,910 | 🐛 205 | 🌐 Go | 📅 2026-02-17
* JavaScript/Node.js: [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,525 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09
* Python: [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,936 | 🐛 213 | 🌐 Python | 📅 2024-06-29 - Puppeteer port
* C#/.NET: [Puppeteer Sharp](https://github.com/hardkoded/puppeteer-sharp) ⭐ 3,887 | 🐛 16 | 🌐 C# | 📅 2026-05-08 - Puppeteer port
* TypeScript/Node.js: [Taiko](https://github.com/getgauge/taiko/) ⭐ 3,668 | 🐛 50 | 🌐 JavaScript | 📅 2026-05-01
* Ruby: [Ferrum](https://github.com/route/ferrum) ⭐ 2,005 | 🐛 36 | 🌐 Ruby | 📅 2026-04-22 - high-level API to control Chrome in Ruby
* Ruby: [Cuprite](https://github.com/machinio/cuprite) ⭐ 1,368 | 🐛 38 | 🌐 Ruby | 📅 2026-05-08 - Capybara driver
* PHP: [PuPHPeteer](https://github.com/rialto-php/puphpeteer) ⚠️ Archived - PHP bridge to node Puppeteer
* Java: [jvppeteer](https://github.com/fanyong920/jvppeteer) ⭐ 805 | 🐛 12 | 🌐 Java | 📅 2026-04-26  - Headless Chrome For Java
...
* PHP: [chrome-devtools-protocol](https://github.com/jakubkulhan/chrome-devtools-protocol) ⭐ 183 | 🐛 20 | 🌐 PHP | 📅 2026-05-09 - A PHP client library for the protocol.
* Python: [PyCDP](https://github.com/hyperiongray/python-chrome-devtools-protocol) ⭐ 143 | 🐛 113 | 🌐 Python | 📅 2026-04-18 - Pure-Python, sans-IO wrappers. See also the [Trio CDP driver](https://github.com/hyperiongray/trio-chrome-devtools-protocol) ⭐ 72 | 🐛 72 | 🌐 Python | 📅 2026-04-08
...
* Kotlin: [chrome-devtools-kotlin](https://github.com/joffrey-bion/chrome-devtools-kotlin) ⭐ 60 | 🐛 15 | 🌐 Kotlin | 📅 2026-05-08 - A coroutine-based client library, providing low-level CDP primitives and high-level extensions.
* TypeScript/Node.js: [Lumen](https://github.com/omxyz/lumen) ⭐ 47 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-30 - Vision-first browser agent with self-healing deterministic replay over CDP.
...
* C#/.NET: [dotnet-chrome-protocol](https://github.com/seclerp/dotnet-chrome-protocol) ⭐ 28 | 🐛 16 | 🌐 C# | 📅 2026-05-01 - A runtime library and schema code generation tools for Chrome DevTools Protocol support in C#/.NET.
...
* [devtools-remote-debugger](https://github.com/Nice-PLQ/devtools-remote-debugger) ⭐ 417 | 🐛 8 | 🌐 JavaScript | 📅 2025-12-05 - Use devtools against a webpage; a CDP agent implemeted in client-side JS.
...
* [j2v8-debugger](https://github.com/AlexTrotsenko/j2v8-debugger) ⭐ 93 | 🐛 5 | 🌐 Kotlin | 📅 2025-02-04 - Debugging JavaScript running in [J2V8](https://github.com/eclipsesource/J2V8) ⭐ 2,634 | 🐛 178 | 🌐 Java | 📅 2025-11-14 with Chrome DevTools.
...
* [thetool](https://github.com/sfninja/thetool) ⭐ 224 | 🐛 14 | 🌐 JavaScript | 📅 2023-01-03 - CPU, memory, coverage, type profiling with Node.
...
* [ruby/debug](https://github.com/ruby/debug) ⭐ 1,264 | 🐛 92 | 🌐 Ruby | 📅 2026-04-29 - Debugging functionality for Ruby.
...
* [BrowserBox](https://github.com/BrowserBox/BrowserBox) ⭐ 3,837 | 🐛 0 | 🌐 Shell | 📅 2026-04-29 - Embed Chrome in a web page, largely powered by DevTools and supporting multiuser browsing, remote DevTools, audio, and documents like `.docx`, `.pdf`, and more.
* [Puppetromium](https://github.com/dosyago/puppetromium) ⭐ 66 | 🐛 1 | 🌐 JavaScript | 📅 2023-07-23 - A proof-of-concept web browser built with Puppeteer, written in Node.js, HTML and CSS, with 0% client-side JavaScript.
...
* [Vue.js Developer Tools](https://github.com/vuejs/vue-devtools) ⭐ 24,740 | 🐛 516 | 🌐 TypeScript | 📅 2024-09-11 - Inspect Vue.js components and manipulate their data.
...
* [sloth](https://github.com/denar90/sloth) ⭐ 199 | 🐛 3 | 🌐 JavaScript | 📅 2019-05-03 - Chrome extension allows to enable and save CPU and network throttling for selected tabs.
...
* [Puppeteer IDE](https://github.com/gajananpp/puppeteer-ide-extension) ⭐ 243 | 🐛 12 | 🌐 TypeScript | 📅 2023-11-13 - Standalone Puppeteer playground in browser's developer tools.

## Alumni

Old projects, likely not maintained any longer… But still cool.

* [ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,161 | 🐛 18 | 🌐 C | 📅 2025-07-02 - Exposes Mobile Safari & UIWebView instances via the CDP.
