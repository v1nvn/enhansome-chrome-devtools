...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 809 | 🐛 698 | 🌐 TypeScript | 📅 2026-02-14 - Elements panel inside VS Code.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 93,962 | 🐛 302 | 🌐 TypeScript | 📅 2026-03-29 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,550 | 🐛 23 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,181 | 🐛 607 | 🌐 TypeScript | 📅 2026-03-28 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,407 | 🐛 6 | 📅 2026-03-22.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 12,880 | 🐛 172 | 🌐 Go | 📅 2026-03-23 - High-level actions and tasks for driving browsers
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 6,825 | 🐛 201 | 🌐 Go | 📅 2026-02-17
...
* Ruby: [Cuprite](https://github.com/machinio/cuprite) ⭐ 1,360 | 🐛 49 | 🌐 Ruby | 📅 2026-03-28 - Capybara driver
...
* Python: [PyCDP](https://github.com/hyperiongray/python-chrome-devtools-protocol) ⭐ 139 | 🐛 77 | 🌐 Python | 📅 2026-03-27 - Pure-Python, sans-IO wrappers. See also the [Trio CDP driver](https://github.com/hyperiongray/trio-chrome-devtools-protocol) ⭐ 71 | 🐛 63 | 🌐 Python | 📅 2026-03-27
...
* TypeScript/Node.js: [Lumen](https://github.com/omxyz/lumen) ⭐ 38 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-26 - Vision-first browser agent with self-healing deterministic replay over CDP.
...
* [Facebook Stetho](https://github.com/facebook/stetho) ⭐ 12,701 | 🐛 85 | 🌐 Java | 📅 2024-10-26 - Native Android debugging with Chrome DevTools.
...
* [BrowserBox](https://github.com/BrowserBox/BrowserBox) ⭐ 3,809 | 🐛 5 | 🌐 Shell | 📅 2026-03-27 - Embed Chrome in a web page, largely powered by DevTools and supporting multiuser browsing, remote DevTools, audio, and documents like `.docx`, `.pdf`, and more.
...
* [Vue.js Developer Tools](https://github.com/vuejs/vue-devtools) ⭐ 24,768 | 🐛 516 | 🌐 TypeScript | 📅 2024-09-11 - Inspect Vue.js components and manipulate their data.
