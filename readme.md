...
* [Chrome Secret Menus](https://github.com/sparkyrider/chrome-secret-menus) ⭐ 65 | 🐛 1 | 📅 2026-01-21 - Comprehensive guide to internal pages and diagnostic tools in Chrome.
* [Front-end Debugging Tools Handbook](https://github.com/lala-hakobyan/front-end-debugging-handbook) ⭐ 45 | 🐛 0 | 📅 2026-03-12 - Practical guide to mastering front-end debugging tools, from Chrome DevTools and framework extensions to AI-enhanced IDE debugging.
...
* [betwixt](https://github.com/kdzwinel/betwixt) ⭐ 4,560 | 🐛 22 | 🌐 JavaScript | 📅 2021-11-23 - System level network proxy, providing inspection via Network panel.
...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 814 | 🐛 754 | 🌐 TypeScript | 📅 2026-02-14 - Elements panel inside VS Code.
...
* [ChromeDevTools/devtools-protocol](https://github.com/chromedevtools/devtools-protocol) ⭐ 1,467 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-09 - **Canonical location of the protocol JSON**. Issue tracker for protocol bugs. TypeScript types.
...
* [chrome-remote-interface Wiki](https://github.com/cyrus-and/chrome-remote-interface/wiki) ⭐ 4,520 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 - Many useful recipes.
* [Chrome Protocol Proxy](https://github.com/wendigo/chrome-protocol-proxy) ⭐ 248 | 🐛 1 | 🌐 Go | 📅 2025-01-31 - Tool for debugging clients using devtools protocol.

### The big two automation libraries

* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 94,067 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-09 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,549 | 🐛 23 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,960 | 🐛 607 | 🌐 TypeScript | 📅 2026-04-10 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,424 | 🐛 8 | 📅 2026-03-22.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 12,935 | 🐛 172 | 🌐 Go | 📅 2026-03-23 - High-level actions and tasks for driving browsers
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 6,845 | 🐛 202 | 🌐 Go | 📅 2026-02-17
* JavaScript/Node.js: [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,520 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09
* Python: [pyppeteer](https://github.com/pyppeteer/pyppeteer) ⭐ 3,939 | 🐛 213 | 🌐 Python | 📅 2024-06-29 - Puppeteer port
* C#/.NET: [Puppeteer Sharp](https://github.com/hardkoded/puppeteer-sharp) ⭐ 3,870 | 🐛 10 | 🌐 C# | 📅 2026-04-01 - Puppeteer port
* TypeScript/Node.js: [Taiko](https://github.com/getgauge/taiko/) ⭐ 3,664 | 🐛 52 | 🌐 JavaScript | 📅 2026-03-28
* Ruby: [Ferrum](https://github.com/route/ferrum) ⭐ 1,992 | 🐛 34 | 🌐 Ruby | 📅 2026-03-24 - high-level API to control Chrome in Ruby
* Ruby: [Cuprite](https://github.com/machinio/cuprite) ⭐ 1,363 | 🐛 39 | 🌐 Ruby | 📅 2026-04-04 - Capybara driver
* PHP: [PuPHPeteer](https://github.com/rialto-php/puphpeteer) ⚠️ Archived - PHP bridge to node Puppeteer
* Java: [jvppeteer](https://github.com/fanyong920/jvppeteer) ⭐ 807 | 🐛 12 | 🌐 Java | 📅 2026-03-29  - Headless Chrome For Java
* Go: [cdp](https://github.com/mafredri/cdp) ⭐ 788 | 🐛 15 | 🌐 Go | 📅 2025-12-07
* Go: [godet](https://github.com/raff/godet) ⭐ 400 | 🐛 2 | 🌐 Go | 📅 2026-03-17
* Java: [chrome-devtools-java-client](https://github.com/kklisura/chrome-devtools-java-client) ⭐ 237 | 🐛 51 | 🌐 Java | 📅 2024-07-25
* Python: [ChromeController](https://github.com/fake-name/ChromeController) ⭐ 226 | 🐛 5 | 🌐 Python | 📅 2025-05-25 - high-level browser mgmt
* Go: [gcd](https://github.com/wirepair/gcd) ⭐ 187 | 🐛 2 | 🌐 Go | 📅 2024-10-16
* PHP: [chrome-devtools-protocol](https://github.com/jakubkulhan/chrome-devtools-protocol) ⭐ 183 | 🐛 20 | 🌐 PHP | 📅 2026-04-10 - A PHP client library for the protocol.
* Python: [PyCDP](https://github.com/hyperiongray/python-chrome-devtools-protocol) ⭐ 140 | 🐛 90 | 🌐 Python | 📅 2026-04-08 - Pure-Python, sans-IO wrappers. See also the [Trio CDP driver](https://github.com/hyperiongray/trio-chrome-devtools-protocol) ⭐ 72 | 🐛 72 | 🌐 Python | 📅 2026-04-08
* TypeScript/Node.js: [chrome-debugging-client](https://github.com/TracerBench/chrome-debugging-client) ⭐ 135 | 🐛 23 | 🌐 TypeScript | 📅 2026-04-04
...
* Kotlin: [chrome-devtools-kotlin](https://github.com/joffrey-bion/chrome-devtools-kotlin) ⭐ 59 | 🐛 13 | 🌐 Kotlin | 📅 2026-04-09 - A coroutine-based client library, providing low-level CDP primitives and high-level extensions.
* TypeScript/Node.js: [Lumen](https://github.com/omxyz/lumen) ⭐ 42 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-30 - Vision-first browser agent with self-healing deterministic replay over CDP.
...
* C#/.NET: [dotnet-chrome-protocol](https://github.com/seclerp/dotnet-chrome-protocol) ⭐ 27 | 🐛 16 | 🌐 C# | 📅 2026-03-31 - A runtime library and schema code generation tools for Chrome DevTools Protocol support in C#/.NET.
...
* [devtools-remote-debugger](https://github.com/Nice-PLQ/devtools-remote-debugger) ⭐ 413 | 🐛 8 | 🌐 JavaScript | 📅 2025-12-05 - Use devtools against a webpage; a CDP agent implemeted in client-side JS.
...
* [j2v8-debugger](https://github.com/AlexTrotsenko/j2v8-debugger) ⭐ 94 | 🐛 5 | 🌐 Kotlin | 📅 2025-02-04 - Debugging JavaScript running in [J2V8](https://github.com/eclipsesource/J2V8) ⭐ 2,631 | 🐛 178 | 🌐 Java | 📅 2025-11-14 with Chrome DevTools.
...
* [ruby/debug](https://github.com/ruby/debug) ⭐ 1,260 | 🐛 90 | 🌐 Ruby | 📅 2026-04-05 - Debugging functionality for Ruby.
...
* [BrowserBox](https://github.com/BrowserBox/BrowserBox) ⭐ 3,814 | 🐛 1 | 🌐 Shell | 📅 2026-04-08 - Embed Chrome in a web page, largely powered by DevTools and supporting multiuser browsing, remote DevTools, audio, and documents like `.docx`, `.pdf`, and more.
* [Puppetromium](https://github.com/dosyago/puppetromium) ⭐ 63 | 🐛 1 | 🌐 JavaScript | 📅 2023-07-23 - A proof-of-concept web browser built with Puppeteer, written in Node.js, HTML and CSS, with 0% client-side JavaScript.

### Web Archivers and Indexers

* [dn](https://github.com/dosyago/dn) ⭐ 3,901 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-28 - Archive and index pages you browse for offline viewing and search, implemented using the `Fetch` domain's interceptions, and works with any Chromium-based browser.
...
* [Vue.js Developer Tools](https://github.com/vuejs/vue-devtools) ⭐ 24,761 | 🐛 516 | 🌐 TypeScript | 📅 2024-09-11 - Inspect Vue.js components and manipulate their data.
...
* [ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,153 | 🐛 18 | 🌐 C | 📅 2025-07-02 - Exposes Mobile Safari & UIWebView instances via the CDP.
...
* Python CDP driver: [pychrome](https://github.com/fate0/pychrome) ⭐ 646 | 🐛 33 | 🌐 Python | 📅 2024-06-17 - low level CDP transport handler
